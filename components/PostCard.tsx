...
const PostCard = () => {
  return (
    <div className="max-w-sm w-full lg:w-[13rem] xl:w-[17rem] 2xl:w-[19.5rem] rounded overflow-hidden shadow-lg cursor-pointer bg-button md:hover:-mt-5 md:hover:mb-5 transition-all">
